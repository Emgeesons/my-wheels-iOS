...
-(void)POSTwithToken_runApiSuccessCallback:(SEL)successSelector token:(NSString *)token inDelegate:delegateObj
{
    @try {
        ...
        [_request addValue:token forHTTPHeaderField:@"x-csrf-token"];
...
-(void)ForImageUploding_runApiSuccessCallback:(SEL)successSelector  inDelegate:delegateObj WithImageParameter:(NSMutableDictionary *)Iparameter WithoutImageParameter:(NSMutableDictionary *)WIparameter{
    ...
    @try {
        ...
        for (NSString *key in Iparameter) {
            ...
            [body appendData:[[NSString stringWithFormat:@"Content-Disposition: file; name=\"%@\"; filename=\"image.png\"\r\n",key] dataUsingEncoding:NSUTF8StringEncoding]];
